This code predict the quality of red wine instances into different classes. It is a multi-class classification problem
...
data = "C:/Users/Gabriel/Desktop/red_wine_quality.csv"
df = pd.read_csv(data, delimiter=';')
# Inspect data
print('Inspect Data')
#print(df.to_string())
# Through inspection, the red wine dataset is a dataset of numeric data type having both float and integer values
# However, the data suffers from outliers.
# Check data shape
...
df_class_labels = df['quality'].unique()
print(df_class_labels)

# Class label distribution among samples
class_dist = df['quality'].value_counts()
print(class_dist)


# Converting the multi-class to binary class problem by dividing the wine quality into two buckets of good and
# bad wine
print('Converting Multi-class problem to Binary Problem')
bins = (2, 5.5, 8) #wine quality between 2-6.5 was classified as Low and 6.8-8.0 as High.
...
# Density plots
X.plot(kind='density', subplots=True, layout=(5,5), sharex=False, legend=False, fontsize=1, figsize=(8,8))
plt.show()
...
print('Viewing data after oversampling using SMOTE')
...
print('Low Quality wine:',sum(y_train==0))
print('High Quality wine:',sum(y_train==1))
...
#scale = StandardScaler()# The Standardscaler standardize the data to mean of 0 and std of 1.
...
#plt.show()
plt.savefig('Red_wine_Hyperparameter_Output')
print('\n')
