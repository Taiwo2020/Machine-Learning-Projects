...
# Inspect data
#print(df.to_string())
# Through inspection, the sonar dataset is mixed data having numeric feature values and categorical labels.
# It has no missing values and the class is almost balanced.
# DATA PREPARATION--------------------------------------------------------
# Check data shape
...
print(df3.to_string()) # The sonar dataset has no missing values in the features
...
print('Mine:',grp_data[0])
print('Rock:',grp_data[1])
...
# Visualize data again after the removal of outliers
...
#plt.show()
plt.savefig('Sonar_Hyperparameter_Output')
print('\n')
