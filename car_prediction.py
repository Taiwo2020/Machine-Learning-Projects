The car dataset specifies the prediction of car conditions in four classes, a multi-class classification problem.
...
data = "C:/Users/Gabriel/Desktop/car_data.csv"
df = pd.read_csv(data, delimiter=',', header=None)
# Inspect data
print('Inspect Data')
#print(df)
# Through inspection, the car evaluation dataset is a dataset of categorical type with no missing values but
...
#plt.hist(y_train)
lt.title('Balanced Class Distribution ')
plt.show()

# Performing feature normalization or standardization-----------------------------------
# The range of values for the attributes are of the same range
scale = MinMaxScaler()#StandardScaler()# The Standardscaler standardizes the data to mean of 0 and std of 1.
...
#plt.show()
plt.savefig('Car_Hyperparameter_Output')
print('\n')
