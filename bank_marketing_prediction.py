# This project describes the characteristics of a bank client in order to classify if the client makes a bank term deposit or not. It is a binary classification problem
...
data = "C:/Users/Gabriel/Desktop/bank_data.csv"
...
print('New Data Shape:',df.shape)
# Through inspection, the bank marketing dataset is a multivariate dataset, having continuous,
# and categorical data along with missing values and suffers from outliers.

# Check class labels in the data
df_class_labels = df['y'].unique()
...
print('Replacing unknown with default Nan in Numpy')
...
print('Term Deposit-No:',grp_data[0])
print('Term Deposit-Yes:',grp_data[1])
...
print('Term Deposit-No:',sum(y_train==0))
print('Term Deposit-Yes:',sum(y_train==1))
...
#plt.show()
plt.savefig('Bank_Hyperparameter_Output')
print('\n')
