This project predicts the quality of white wine. It is a multi-class prediction problem
...
data = "C:/Users/Gabriel/Desktop/white_wine_quality.csv"
df = pd.read_csv(data, delimiter=';')
# Inspect data
print('Inspect Data')
#print(df.to_string())
# Through inspection, the white wine dataset shares the same characteristics as the red wine but has more samples
# Check data shape
...
bins = (2, 6, 9) #wine quality between 2-6.5 was classified as low quality and 6.8-8.0 as high quality.
group_names = ['Low', 'High']
df['quality'] = pd.cut(df['quality'], bins = bins, labels = group_names)
print(df.head(20))


# Check new class distribution among samples
new_class_dist = df.groupby('quality').size()
...
scale = MinMaxScaler()#StandardScaler()# The standardscaler scale the data to mean of 0 and std of 1.
...
#plt.show()
plt.savefig('White_wine_Hyperparameter_Output')
print('\n')
